...
exports.FilterPanelStyles = exports.ColumnManagementStyles = exports.StyledDataGrid = void 0;
const common_1 = require("@/app/utils/common");
const material_1 = require("@mui/material");
const x_data_grid_premium_1 = require("@mui/x-data-grid-premium");
exports.StyledDataGrid = (0, material_1.styled)(x_data_grid_premium_1.DataGridPremium)(({ theme }) => ({
    [`& .${x_data_grid_premium_1.gridClasses.columnHeader}[data-field="__row_group_by_columns_group__"]`]: {
        // width: '240px !important',
        fontSize: '14px',
    },
    [`& .${x_data_grid_premium_1.gridClasses.columnHeader}[data-fields="|-__row_group_by_columns_group__-|"]`]: {
        // width: '240px !important',
        fontWeight: "bold"
    },
    [`& .${x_data_grid_premium_1.gridClasses.columnHeader}:focus, & .${x_data_grid_premium_1.gridClasses.columnHeader}:focus-within`]: {
        outline: 'none',
    },
    [`& .${x_data_grid_premium_1.gridClasses.cell}[data-field="__row_group_by_columns_group__"]`]: {
    // width: '240px',
    },
    [`& .${x_data_grid_premium_1.gridClasses.cell}[data-field="__row_group_by_columns_group__"].firstGroupsRow`]: {
        '&:before': {
            content: '""',
            position: 'absolute',
            top: '5px',
            ...
            width: '5px',
            height: '40px',
            backgroundColor: (0, common_1.getInitialsColor)('A', 'B', 'C', 'D') || '#FFBFB0',
        },
    },
    '& .MuiDataGrid-cell.MuiDataGrid-cell--editing': {
        boxShadow: 'none !important',
    },
    [`& .${x_data_grid_premium_1.gridClasses.columnHeader}`]: {
        '&.prime-header': {},
        '&.secondary-header': {},
        '&.weekly-header': {},
    },
    [`& .${x_data_grid_premium_1.gridClasses.cell}`]: {
        '&.prime-cell': {},
        '&.secondary-cell': {},
        '&.weeklyCell': {},
    },
...
exports.ColumnManagementStyles = {
