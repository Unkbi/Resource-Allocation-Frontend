...
const ProjectTable_1 = __importDefault(require("@/app/components/Projects/Table/ProjectTable"));
...
const CustomAvatar_1 = __importDefault(require("@/app/components/Avatar/CustomAvatar"));
const DeleteDialog_1 = __importDefault(require("@/app/components/Dialog/DeleteDialog"));
...
const AvatarCircle = (0, system_1.styled)('div')(({ bgcolor }) => ({
    display: 'flex',
    alignItems: 'center',
...
const PersonContainer = (0, system_1.styled)('div')(() => ({
    display: 'flex',
    alignItems: 'center',
    justifyContent: 'flex-start'
}));
const StatusPill = (0, system_1.styled)('div')(({ theme, status }) => {
...
function Project() {
    ...
    const { projects, updating, loading } = (0, react_redux_1.useSelector)(state => state.projects);
    const [anchorEl, setAnchorEl] = (0, react_1.useState)(null);
    const [selectedRow, setSelectedRow] = (0, react_1.useState)(null);
    const [rows, setRows] = (0, react_1.useState)(projects?.result || null);
    const [deleteDialogOpen, setDeleteDialogOpen] = (0, react_1.useState)(false);
    const [projectToDelete, setProjectToDelete] = (0, react_1.useState)(null);
    (0, react_1.useEffect)(() => {
        if (!updating) {
            ...
            return data.map((item) => {
                return {
                    ...
                    Owner: {
                        name: item.Owner,
                        bgColor: "#fff",
                        initials: (0, common_1.getInitials)(item.Owner),
                    },
                };
            });
        }
    ...
    const handleConfirmDelete = () => {
        if (!projectToDelete?.Id)
            return;
        dispatch((0, projectServices_1.deleteProject)(projectToDelete.Id))
            .then(() => dispatch((0, projectServices_1.getAllProjects)()));
    ...
    const columns = [
        ...
        },
        {
            ...
            renderCell: (params) => {
                ...
                // </PersonContainer>
                owner.name && React.createElement(CustomAvatar_1.default, { value: owner.name, showFullName: true }));
            },
        },
        {
            field: "Manager",
            ...
            renderCell: (params) => {
                ...
                //   <span>{manager}</span>
                // </PersonContainer>
                manager && React.createElement(CustomAvatar_1.default, { value: manager, showFullName: true }));
            },
        },
        {
            field: "Location",
        ...
        },
        {
            ...
            flex: 1,
            minWidth: 140,
            renderCell: (params) => (React.createElement(StatusPill, { status: params.value }, params.value)),
        },
        {
            field: "StartDate",
        ...
        },
        {
            ...
            sortable: false,
            filterable: false,
            renderCell: (params) => (React.createElement(React.Fragment, null,
                React.createElement(material_1.IconButton, { size: "small", onClick: (e) => handleMenuClick(e, params.row.id) },
                    React.createElement(MoreVert_1.default, { fontSize: "small" })),
                React.createElement(material_1.Menu, { anchorEl: anchorEl, open: Boolean(anchorEl) && selectedRow === params.row.id, onClose: handleMenuClose, anchorOrigin: {
                        vertical: "bottom",
                        horizontal: "right",
                    }, transformOrigin: {
                        vertical: "top",
                    ...
                    React.createElement(material_1.MenuItem, { onClick: () => { handleOpenDialog("Edit Project", "edit_project", params.row), handleMenuClose(); } }, "Edit Project"),
                    React.createElement(material_1.MenuItem, { onClick: () => { setProjectToDelete(params.row); setDeleteDialogOpen(true); handleMenuClose(); } }, "Delete Project")))),
        },
    ];
    ...
    return (React.createElement(system_1.Box, null,
        React.createElement(ProjectTable_1.default, { loading: loading, columns: columns, rows: modifyData(rows) }),
        React.createElement(DeleteDialog_1.default, { open: deleteDialogOpen, onConfirm: handleConfirmDelete, onCancel: handleCancelDelete, title: "Are you sure you want to delete this project?" }, "This will permanently delete the project.")));
}
