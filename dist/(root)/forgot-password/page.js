...
function ForgotPasswordPage() {
    ...
    const { loading, error, forgotPasswordMessage } = (0, react_redux_1.useSelector)((state) => state.user);
    ...
    return (react_1.default.createElement(MainBox, { sx: { display: 'flex', minHeight: '100vh' } },
        react_1.default.createElement(material_1.Box, { display: "flex", width: '100%' },
            ...
            react_1.default.createElement(material_1.Box, { className: 'loginRight' },
                react_1.default.createElement(material_1.Box, { className: 'formBox' },
                    react_1.default.createElement(material_1.Typography, { variant: "h4" }, "Forgot Password"),
                    react_1.default.createElement(material_1.Typography, { className: 'subHeadingText' }, "We will send you an link to reset your password"),
                    react_1.default.createElement(material_1.Box, { component: "form", onSubmit: handleForgotPassword },
                        ...
                        react_1.default.createElement(material_1.Button, { type: "submit", variant: "contained", color: "primary", fullWidth: true, disabled: loading, sx: { mt: 2 }, className: 'signInButton' }, loading ? react_1.default.createElement(material_1.CircularProgress, { size: 24 }) : 'Submit')),
        ...
        (forgotPasswordMessage && !error) && (react_1.default.createElement(material_1.Typography, { variant: "body2", color: "success", sx: { position: 'absolute', bottom: '150px', left: '75%', transform: 'translateX(-50%)' } }, "A password reset link has been sent to your email. Please check your inbox and follow the instructions to reset your password.")),
        error && (react_1.default.createElement(material_1.Typography, { variant: "body2", color: "error", sx: { position: 'absolute', bottom: '150px', left: '75%', transform: 'translateX(-50%)' } }, error))));
}
