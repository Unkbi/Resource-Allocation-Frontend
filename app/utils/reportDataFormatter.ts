...
const formatResourcePeriod = (data: any[]): any[] => {
    ...
    return formattedData.map((item: any, index: any) => ({
        ...
        planning_score: safeGet(item, 'ResourceEngagementScore', 0),
        actuals_score: safeGet(item, 'ResourceEngagementScore', 0),
        confirmation_score: safeGet(item, 'ResourceEngagementScore', 0),
        entry_score: safeGet(item, 'ResourceEngagementScore', 0),
        communication_score: safeGet(item, 'ResourceEngagementScore', 0),
        engagement_score: safeGet(item, 'ResourceEngagementScore', 0),
        created: formatDate(safeGet(item, 'Resource.__created')),
        created_by: safeGet(item, 'Resource.__created_by', ''),
        last_modified: formatDate(safeGet(item, 'Resource.__last_modified')),
        last_modified_by: safeGet(item, 'Resource.__last_modified_by', ''),
